...
const EditProcedureItemDialog = (props) => {
  ...
  const save = () =>{
    ...
    axios.put(url+'api/procedure-medicine',data)
  ...
  return (
    <div>
        ...
        <DialogTitle  className='text-center'><b>Edit Item Form</b></DialogTitle>
        <DialogContent>
...
export default EditProcedureItemDialog