...
const List = () => {
  ...
  return (
    <div>
        <Nav/>
        <Top>
          <Left><Title>Supplier List</Title></Left>
          <Right><Button  onClick={()=>setIsShow(true)}><AiOutlinePlus style={{marginRight:'7px'}}/>Add Supplier</Button></Right>
        </Top>
         <Div className='card'>
         ...
         <AddSupplierDialog open={isShow} close={()=>setIsShow(false)}/>
    </div>
  )
}
