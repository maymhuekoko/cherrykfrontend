...
const Machinery = () => {
  ...
  useEffect(()=> {
    const getItems = async () =>{
      try{
        ...
        setItems(res.data.list.filter((el) => el.type == 'Medical Equipment' || el.type == 'Surgery Equipment' || el.type == 'Medical Machinery'));
      }catch(err){}
    };
    getItems();
  },[]);
  ...
  return (
    <div>
        <Nav/>
        <Top>
          <Left><Title>Machinery List</Title></Left>
